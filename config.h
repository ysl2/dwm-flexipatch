...
static char selbordercolor[]             = "#2e9ef4";
static char selfloatcolor[]              = "#2e9ef4";
...
static const Rule rules[] = {
	...
	#endif // SCRATCHPADS_PATCH
	#if SWALLOW_PATCH
    RULE(.instance = "st-256color", .class = "st-256color", .isterminal = 1)
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask|ControlMask, XK_j,          inplacerotate,          {.i = +2 } }, // same as rotatestack
	{ MODKEY|ShiftMask|ControlMask, XK_k,          inplacerotate,          {.i = -2 } }, // same as reotatestack
	...
	#endif // TAGALL_PATCH
	#if TAGALLMON_PATCH
	{ MODKEY|Mod1Mask|ShiftMask|ControlMask, XK_l, tagallmon,              {.i = +1 } },
	{ MODKEY|Mod1Mask|ShiftMask|ControlMask, XK_h, tagallmon,              {.i = -1 } },
	#endif // TAGALLMON_PATCH
	#if TAGSWAPMON_PATCH
	{ MODKEY|Mod1Mask|ControlMask,  XK_l,          tagswapmon,             {.i = +1 } },
	{ MODKEY|Mod1Mask|ControlMask,  XK_h,          tagswapmon,             {.i = -1 } },
